  ...
  const villageProfileData = [
    {
      key: 'vision',
      value:
        'Desa Banyuanyar Mewujudkan Sebagai Kawasan Desa Hijau dan Pintar (Green Smart Village ) Menuju Desa Mandiri, Religius, Berbudaya Sesuai Dengan Nilai-Nilai Pancasila',
      name: 'Visi desa'
    },
    {
      key: 'history',
    ...
    },
    {
      key: 'mission_1',
      value:
        'Menanamkan nilai-nilai religius dan kearifan lokal melalui Program Pengembangan Aspek-aspek Spiritual Ramah Anak dan Adat Istiadat.',
      name: 'Misi 1'
    },
    {
      key: 'mission_2',
      value:
        'Meningkatkan Kegiatan dan Program Desa Dalam Keikutsertaan Kedaulatan Desa Mencapai Kedaulatan Nasional.',
      name: 'Misi 2'
    },
    {
      key: 'mission_3',
      value:
        'Meningkatkan ketersediaan sarana dan prasarana umum yang aman dan nyaman melalui Program Peningkatan Sarana prasarana Umum Berbasis Teknologi Ramah Lingkungan.',
      name: 'Misi 3'
    },
    {
      key: 'mission_4',
      value:
        'Meningkatkan kualitas pelayanan masyarakat dan transparansi Berbasis Teknologi Informatika dan Smartphone (Digital Village).',
      name: 'Misi 4'
    },
    {
      key: 'mission_5',
      value:
        'Meningkatkan kualitas pendidikan baik formal maupun non formal melalui Gerakan Kampung Ramah Anak.',
      name: 'Misi 5'
    },
    {
      key: 'mission_6',
      value:
        'Mengembangkan ketersediaan fasilitas penunjang desa wisata melalui Program Peningkatan Sarana Prasarana Destinasi Pariwisata Kampung Susu dan Kopi (Tourist Village Of Milk And Coffee).',
      name: 'Misi 6'
    },
    {
      key: 'mission_7',
      value:
        'Mewujudkan sistem usaha mandiri desa melalui Badan Usaha Milik Desa (BUM Desa).',
      name: 'Misi 7'
    },
    {
      key: 'mission_8',
      value:
        'Meningkatkan hasil produksi perkebunan, peternakan, dan pertanian masyarakat melalui Gerakan Mandiri Pangan menuju Kampung Iklim (Climate Village) dan Mandiri Energi (Energy Village Endurance).',
      name: 'Misi 8'
    },
    {
      key: 'mission_9',
      value:
        'Meningkatkan produktivitas ekonomi masyarakat melalui Program Peningkatan Pengetahuan dan Produktivitas Keterampilan Masyarakat (Vocational Village).',
      name: 'Misi 9'
    },
    {
      key: 'mission_10',
    ...
    },
    {
      key: 'mission_11',
      value:
        'Mewujudkan Program Keluarga Harapan Untuk Peningkatan Kesejahteraan Keluarga Dan Kualitas Hidup Masyarakat Desa (Quality Of Life).',
      name: 'Misi 11'
    },
    {
      key: 'objectives',
