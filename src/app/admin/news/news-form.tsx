...
interface NewsFormProps {
  ...
  createNews?: (formData: FormData) => Promise<{ success: boolean; data?: any; error?: string }>
  updateNews?: (id: number, formData: FormData) => Promise<{ success: boolean; data?: any; error?: string }>
}

export function NewsForm({ news, categories, createNews, updateNews }: NewsFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Isi detail news yang akan dibuat
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
