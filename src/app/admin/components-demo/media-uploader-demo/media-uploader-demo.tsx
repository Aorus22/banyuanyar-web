      ...
      <div className='space-y-4 text-center'>
        ...
        <div className='text-muted-foreground grid grid-cols-1 gap-4 text-sm md:grid-cols-3'>
          <div className='space-y-2'>
            <h3 className='text-foreground font-medium'>🚀 Upload Gambar</h3>
          ...
          <div className='space-y-2'>
            <h3 className='text-foreground font-medium'>🎯 Entity Specific</h3>
      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-4'>
            <div>
              <h4 className='mb-2 font-medium'>1. Uploader Sederhana</h4>
...
>
  <Button>Upload Gambar</Button>
            ...
            <div>
              <h4 className='mb-2 font-medium'>2. Media Manager Lengkap</h4>
              <pre className='bg-muted overflow-x-auto rounded p-3 text-sm'>
                {`<MediaManager
  entityType="news"
  entityId={123}
...
/>`}
            ...
            <div>
              <h4 className='mb-2 font-medium'>3. Gallery Terpisah</h4>
              <pre className='bg-muted overflow-x-auto rounded p-3 text-sm'>
                {`<MediaGallery
  media={mediaList}
  entityType="news"
