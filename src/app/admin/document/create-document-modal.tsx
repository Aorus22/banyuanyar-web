...
export function CreateDocumentModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const uploadResult = await uploadDocumentToGoogleDrive(uploadedFile, uploadedFile.name);
      ...
      if (result.success) {
        ...
        toast.error(`Gagal membuat dokumen: ${result.error || 'Unknown error'}`);
      }
    } catch (error) {
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-lg font-medium">
                  {isDragActive ? 'Jatuhkan file PDF di sini' : 'Drag & drop file PDF di sini'}
                </p>
              ...
              <div className="flex items-center justify-between p-3 bg-background rounded border">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-muted-foreground">{formatFileSize(uploadedFile.size)}</p>
                  </div>
                </div>
                <Button
                  type="button"
