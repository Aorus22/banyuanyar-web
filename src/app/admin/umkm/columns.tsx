  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className='text-center'>
        <Badge variant='secondary'>{row.original._count.products} produk</Badge>
      </div>
    ),
    enableSorting: true,
    enableHiding: true,
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align='end'>
            ...
            <DropdownMenuItem asChild>
              <Link href={`/admin/umkm/${umkm.id}`} className='w-full !p-0'>
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (result.success) {
                      ...
                      toast.error(
                        `Gagal menghapus UMKM: ${result.error || 'Unknown error'}`
                      );
                    }
                  } catch (error) {
