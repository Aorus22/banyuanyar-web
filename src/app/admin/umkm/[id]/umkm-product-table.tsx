...
export default function UmkmProductTable({ umkmId, products, showCreateButton = false }: UmkmProductTableProps) {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <Link href={`/admin/umkm/${umkmId}/product/${product.id}/edit`} className="w-full">
