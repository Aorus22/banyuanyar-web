...
const formSchema = z.object({
  ...
  price: z.string().min(1, "Harga harus diisi").refine((val) => !isNaN(parseFloat(val)) && parseFloat(val) > 0, {
...
interface UmkmProductFormProps {
  ...
  umkmId: number
  createProduct?: (umkmId: number, formData: FormData) => Promise<{ success: boolean; data?: any; error?: string }>
  updateProduct?: (id: number, formData: FormData) => Promise<{ success: boolean; data?: any; error?: string }>
}

export function UmkmProductForm({ product, umkmId, createProduct, updateProduct }: UmkmProductFormProps) {
