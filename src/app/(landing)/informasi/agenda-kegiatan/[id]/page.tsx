...
export default async function EventDetailPage({
  ...
  return (
    <div className='container mx-auto mt-24 max-w-4xl px-4 py-8'>
      {/* Back Button */}
      <div className='mb-6'>
      ...
      <div className='mb-8'>
        ...
        <h1 className='mb-4 text-4xl leading-tight font-bold'>{event.title}</h1>
      ...
      {event.description && (
        <div className='max-w-none'>
          <h2 className='mb-4 text-2xl font-semibold'>Deskripsi Kegiatan</h2>
          ...
          <CardContent className='space-y-4'>
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-sm'>{safeFormatDateFullMonth(event.date)}</p>
              </div>
