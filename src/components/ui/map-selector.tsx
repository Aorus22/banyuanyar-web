...
export function MapSelector({
      ...
      (error) => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            errorMessage =
              'Izin lokasi ditolak. Silakan izinkan akses lokasi di pengaturan browser.';
            break;
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        className={cn(
          'max-h-[90vh] max-w-5xl overflow-y-auto rounded-xl p-6 shadow-2xl',
          className
        )}
      >
        <DialogHeader>
          <DialogTitle className='text-2xl font-bold'>Pilih Lokasi</DialogTitle>
          <DialogDescription>
            Klik pada peta untuk memilih lokasi atau masukkan koordinat secara
            manual
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='space-y-6'>
          <div className='relative'>
            <div
              ref={mapContainerRef}
              className='border-border bg-muted/20 h-96 w-full rounded-xl border shadow-inner'
