      ...
      <PopoverContent className='w-auto p-0' align='start'>
        <div className='rounded-md border p-3'>
          ...
          <div className='mb-4 flex items-center justify-between gap-2'>
            <Select
              value={
                selectedDate ? (selectedDate.getMonth() + 1).toString() : '1'
              }
              ...
              <div className='space-y-3'>
                <div className='relative'>
                  <Button
                    ...
                    disabled={disabled}
                    className='h-12 w-full justify-center gap-2 font-mono text-lg'
                  >
                  ...
                  {/* Time Dropdown */}
                  {showTimeDropdown && (
                    <div className='bg-card absolute right-0 bottom-full left-0 z-50 mb-1 rounded-md border shadow-lg'>
                      <div className='p-3'>
