      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={state.onConfirm}>Ya</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
...
export function confirmModal(
  ...
  if (!globalShowConfirm) {
    throw new Error(
      'confirmModal is not initialized. Please wrap your app with ConfirmDialogProvider and call setGlobalConfirmDialog'
    );
  }
